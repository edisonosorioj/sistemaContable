...
$query = mysqli_query($result, "select * from sede where sede_id = '$id'");
							...
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action="actSede.php" method="post"> 
										...
										<div class="form-group"> 
											<label>Estado - Seleccione 0 = Inactivo, 1 = Activo</label> 
											<input type="text" name="estado" class="form-control" placeholder="Estado" value="<?php echo $row['estado']; ?>"> 
										</div>
										<div class="form-group"> 
											<label>Color</label> 
											<input type="color" name="color" class="form-control" placeholder="Color" value="<?php echo $row['color']; ?>"> 
										</div> 
