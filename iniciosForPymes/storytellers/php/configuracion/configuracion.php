									...
									<table class='table'>
										<tbody>
											<tr>
												...
												<td class='type-info'>
													<button type='button' class='btn-hover btn-xs btn-block hvr-icon-float-away' onclick='javascript:abrir(\"../../html/configuracion/crearUsuario.php\")'>Crear</button>
												</td>	
											</tr>
											<tr>
												<td>
													<h4>2. Crear nueva Sede<a href='verSedes.php'> Ver</a></h4>
												</td>
												<td class='type-info'>
