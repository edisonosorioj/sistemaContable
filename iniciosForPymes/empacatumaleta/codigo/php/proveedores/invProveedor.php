...
// Obtiene el ID enviado desde Proveedor para visualizar sus productos.
$id = $_GET['id'];


$query = mysqli_query($result,"select * from productos where idproductos != 0 and proveedor_id = '$id' order by idproductos;");
 ...
 while ($row = $query->fetch_array(MYSQLI_BOTH)){
	...
	$sumtotal = $row['disponible'] * $row['valor'];
 	...
 	$tr .=	"<tr class='rows' id='rows'>
				...
				<td><a onclick='javascript:abrir(\"editarProductos.php?id=" . $idproductos . "\")'><span data-tooltip='Editar'><i class='fa fa-pencil'></i></spam></a>&nbsp;&nbsp;
				<a onClick=\"return confirmar('¿Estas seguro de eliminar?')\" href='eliminarProductos.php?id=" . $idproductos . "'><span data-tooltip='Eliminar'>
...
$query2 = mysqli_query($result, "SELECT * FROM proveedores WHERE proveedor_id = '$id'");
