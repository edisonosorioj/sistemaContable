...
$query = mysqli_query($result, "select * from variables where variable_id = 11;");

$row=$query->fetch_assoc();

$iva = ($row['detalle'] == '0') ? 'No' : 'Si' ;
					...
					<div class='panel panel-widget forms-panel'>
						<div class='forms'>
							<div class='form-grids widget-shadow' data-example-id='basic-forms'> 
								...
								<div class='form-body'>
									<form action='../../php/configuracion/actIva.php' method='post'> 
										<div class='form-group'> 
											<label>Estado uso del IVA = $iva</label>
											<select name='iva' class='form-control1'>
