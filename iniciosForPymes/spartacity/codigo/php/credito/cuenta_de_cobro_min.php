...
<body>
	<div class='hoja'>
		...
		<div class='encabezado'>$nombre_usuario con Identificador $documento_cliente debe a $nombre_empresa con $tipo $identificacion de $lugar_expedicion, el valor de $valor por concepto de $detalles:</div>
