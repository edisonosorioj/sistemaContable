...
// echo "Llegue aqui";die();
 	...
 	$tr .=	"<tr class='rows' id='rows'>
				...
				<td>
				<a class='botonTab' onclick='javascript:abrir(\"verGrNomina.php?id=" . $row['idgrupo'] . "\")'><span data-tooltip='Usuarios'><i class='fa fa-pencil'></i></spam></a>&nbsp;&nbsp;
...
<body class='dashboard-page'>
		...
		<div class='main-grid'>
			<div class='agile-grids'>	
							...
							<div class='col-md-2'>
								<form class='form-horizontal' action='ejecutarNomina.php' method='post'>
									...
									<div class='form-group'> <label>Valor Nomina: </label> 
										<input type='text' class='form-control' value='$ " . number_format($row3['valor'], 0, ",", ".") . "' disabled/>
									</div> 
				...
				<!-- //tables -->
				<div class='col-md-2'>
					<form class='form-horizontal' action='cancelarGrNomina.php' method='post'>
						<label></label>
						<input type='hidden' name='idnomina' value='$id'>
						<button type='submit' class='btn btn-primary'>Cancelar Nomina</button> 
					</form> 
				</div>
			</div>
		</div>
