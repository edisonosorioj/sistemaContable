								...
								<div class="form-body">
									<form action='editarUsuario.php?id=<?php echo $iduser ?>' method="post"> 
										...
										<div class="form-group"> 
											...
											<input type="text" name="apellido" class="form-control" placeholder="Apellido" value="<?php echo $apellido; ?>" disabled/> 
										</div> 
										<div class="form-group"> 
											<label>CC</label> 
											<input type="text" name="documento" class="form-control" placeholder="Documento" value="<?php echo $documento; ?>" disabled/> 
										</div>
										<div class="form-group"> 
											<label>Fecha Contrato</label> 
											<input type="text" name="fecha_contrato" class="form-control" placeholder="Fecha Contrato" value="<?php echo $fecha_contrato; ?>" disabled/> 
										</div>
										<div class="form-group"> 
											<label>Fecha Fin Contrato</label> 
											<input type="text" name="fecha_fin_contrato" class="form-control" placeholder="Fecha fin de contrato" value="<?php echo $fecha_fin_contrato; ?>" disabled/> 
										</div> 
										<div class="form-group"> 
											<label>Nomina</label> 
											<input type="text" name="valor_nomina" class="form-control" placeholder="Nomina" value="<?php echo $valor_nomina; ?>" disabled/> 
										</div> 
