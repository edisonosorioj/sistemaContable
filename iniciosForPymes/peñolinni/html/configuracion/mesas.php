...
$query = mysqli_query($result, "select * from variables where variable_id = 13;");

$row=$query->fetch_assoc();

$mesas = ($row['detalle'] == '0') ? 'No' : 'Si' ;
					...
					<div class='panel panel-widget forms-panel'>
						<div class='forms'>
							<div class='form-grids widget-shadow' data-example-id='basic-forms'> 
								...
								<div class='form-body'>
									<form action='../../php/configuracion/actMesas.php' method='post'> 
										<div class='form-group'> 
											<label>Estado uso de Mesas = $mesas</label>
											<select name='mesas' class='form-control1'>
