								...
								<div class='form-body'>
									<form action='actUsuario.php' method='post'> 
										...
										<div class='form-group'> 
											...
											<input type='text' name='documento' class='form-control' placeholder='Documento' value='" . $row['documento'] . "'> 
										</div>
										<div class='form-group'> 
											<label>Nombres</label> 
											<input type='text' name='nombre' class='form-control' placeholder='Nombres' value='" . $row['nombre'] . "'> 
										</div> 
										<div class='form-group'> 
											<label>Apellido</label> 
											<input type='text' name='apellido' class='form-control' placeholder='Apellido' value='" . $row['apellido'] . "'> 
										</div> 
										<div class='form-group'> 
											<label>Rol</label>
											<select class='form-control' name='rol'>
												<option value='" . $row['idrol'] . "'>$txtRol</option>
												" . $options . "
											</select>
										</div>
										<div class='form-group'> 
											<label>Login</label> 
											<input type='text' name='login' class='form-control' placeholder='Login' value='" . $row['login'] . "'> 
										</div> 
										<div class='form-group'> 
