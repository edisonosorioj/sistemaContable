					...
					<div class='panel panel-widget forms-panel'>
						<div class='forms'>
							<div class='form-grids widget-shadow' data-example-id='basic-forms'> 
								...
								<div class='form-body'>
									<form action='../../php/inventario/addTipoProducto.php' method='post'> 
										...
										<div class='form-group'> 
											...
											<input type='text' name='cantidad' class='form-control' placeholder='Cantidad ML'> 
										</div>
										<div class='form-group'> 
										...
										<div class='form-group'> 
											...
											<input type='text' name='precio_d' class='form-control' placeholder='Precio Distribuidor'> 
										</div>
