...
if ($estado == 1) {
	...
	$msg = "El registro ya fue realizado, no es posible cambiar los productos. Si desea cambiarlos debe cancelarlo primero el registro y despues realizar de nuevo el procedimiento";
