...
$intereses = str_replace('-', '', $row['intereses']);
...
<body>
	<div class='hoja'>
		...
		<table>
			<tr>
				<td colspan='3'>CENTRO DE NEGOCIOS BROKERS SOLUCIONES 
			</tr>
			<tr>
				</td>
				<td>
		...
		<div class='firma'><p>Atentamente,<br />" . strtoupper($nombre_empresa) . "<br />CEL: $cel</p></div>
	</div>
</body>
</html>";
