								...
								<div class='bs-example'>
									<table class='table'>
										<tbody>
											...
											<tr>
												<td>
													<h4>7. Interfaz Mesas. Estado $mesas</h4>
												</td>
												<td class='type-info'>
													<button type='button' class='btn-hover btn-xs btn-block hvr-icon-float-away' onclick='javascript:abrir(\"../../html/configuracion/mesas.php\")'>Cambiar</button>
												</td>	
											</tr>
										</tbody>
									</table>
