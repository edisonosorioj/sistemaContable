				...
				<div id="reset_card_body_collage" class="card-body ">
					<div class="tab-content text-center">
						<div class="tab-pane active" id="info_propiedad">
							...
							' . $arriendo . '
							' . $venta . '
							<div class="descripcion_propiedad_resum">' . substr($descripcion, 0, 70) . '...<a class="button_mas_propiedad" href="https://www.brokersfast.com.co/propiedad/propiedad.php?id=' . $cod_propiedad . '" title="Ver más información">VER MAS</a></div>
						</div>
					</div>
				</div>
			</div>
