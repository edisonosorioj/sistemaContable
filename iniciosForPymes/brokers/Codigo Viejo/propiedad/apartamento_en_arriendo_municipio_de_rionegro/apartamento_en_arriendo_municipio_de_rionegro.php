<?php $codigo_propiedad = '142'; $val_arriendo = '1300000'; $val_venta = '0'; $copropiedad = 'Copropiedad 1'; $carpeta_propiedad = 'apartamento_en_arriendo_municipio_de_rionegro'; ?>
...
<head>
	...
	<title> 'apartamento en arriendo municipio de rionegro' </title>
				...
				<div class='col-lg-12 col-md-12 ml-auto mr-auto'>
					<div id='formulario_contacto_us' class='card card-login'>            
						<div class='card-header card-header-primary text-center'>
							<h4 class='card-title'>'Rionegro ' - 'Antioquia'</h4>
							...
							<div class='form-row'>
								...
								<div class='form-group col-md-6'>
									<div class='input-group'>
										<h2>'apartamento en arriendo municipio de rionegro'</h2>
									</div>
								</div>

								<div class='form-group col-md-6'>
									<div class='input-group'>
										<h2 id='codigo_propiedad_dpl'>CÓDIGO: '142'</h2>
									</div>
								</div>
									...
									<div style='margin:0px;padding: 0px;' class='input-group'>
										...
										<div class='form-group col-md-12'>
											<div class='input-group'>
												...
												<p class='box_txtdescriptiv_prop'>'&lt;p&gt;RIOGRANDE H&Aacute;BITAT Cuenta con porter&iacute;a cerrada las 24 horas, sus zonas comunes son piscinas climatizadas, sauna, turco, sal&oacute;n social, gimnasio dotado, juegos infantiles y parqueaderos de visitantes.
												...
												<h4 class='box_subtitulos_txt'>Localización , caracteristicas y áreas</h4><br>
												    <table id='table_prop_pub'>
												    	<tr class='impar_color'>
												    		...
												    		<td class='txt_col_2_table'>'Colombia '</td>
												    	</tr>
												    	<tr>
												    	...
												    	<tr class='impar_color'>
												    		...
												    		<td class='txt_col_2_table'>'77.00' M2. aproximadamente</td>
												    	</tr>
												    	<tr>
												    		...
												    		<td class='txt_col_2_table'>'77.00' M2. aproximadamente<br><small>área bruta incluye buitrones, columnas y muros</small></td>
												    	</tr>
												    	<tr class='impar_color'>
												    	...
												    	<tr>
												    		...
												    		<td class='txt_col_2_table'>'101'</td>
												    	</tr>
												    	<tr class='impar_color'>
												    	...
												    	<tr class='impar_color'>
												    		...
												    		<td class='txt_col_2_table'>'1 + Cuarto util.'</td>
												    	</tr>
