...
$area_total 	= $propiedad[4];
$area_construida= $propiedad[5];
$tipo 			= $propiedad[7];
$estrato 		= $propiedad[8];
												...
												<h4 class='box_subtitulos_txt'>Localización , caracteristicas y áreas</h4><br>
												    <table id='table_prop_pub'>
												    	...
												    	<tr class='impar_color'>
												    		...
												    		<td class='txt_col_2_table'><?php echo $area_total; ?> M2</td>
												    	</tr>
												    	<tr>
								...
								<div class='form-group col-md-3'>
									<div class='input-group'>
										<?php 
										 ...
										 ?>
										 <?php 
										/* $Comodidades_Propiedad = Consulta::Comodidades_Propiedad($mysqli, $cod_propiedad);
										 	print_r($Comodidades_Propiedad);die();*/
										  ?>
