							...
							<div class='form-row'>
								...
								<div id="accordion">
								    	...
								    	<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
									      	<div class="card-body">
												<center><iframe src="https://www.brokersfast.com.co/propiedad/tour360/propiedad_ejemplo/index.html" width="500" height="500"> </iframe></center>
							      			</div>
						    			</div>
								</div>
							...
							<div class='form-row'>
								...
								<div class='form-group col-md-9'>
									<div class='input-group'>
										...
										<div class='form-group col-md-6'>
											<div class='input-group'>
												<h3 class='orange_txt'>EN ARRIENDO</h3>&nbsp&nbsp
												<h3><? echo number_format($arriendo, 0, ',', '.'); ?></h3>
											</div>
										</div>
