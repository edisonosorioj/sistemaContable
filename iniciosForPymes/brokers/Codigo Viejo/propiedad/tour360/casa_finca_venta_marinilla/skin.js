...
// Generated Tue Sep 18 19:16:30 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._tt_zoomin__text.innerHTML="Aumentar Zoom";
		...
		this._tt_zoomin_white__text.innerHTML="Aumentar Zoom";
		...
		this._tt_zoomout__text.innerHTML="Disminuir Zoom";
		...
		this._tt_zoomout_white__text.innerHTML="Disminuir Zoom";
		...
		this._tt_stop_auto_rotate__text.innerHTML="Parar Auto Rotaci\xf3n";
		...
		this._tt_stop_auto_rotate_white__text.innerHTML="Parar Auto Rotaci\xf3n";
		...
		this._tt_start_auto_rotate__text.innerHTML="Inicio Auto Rotaci\xf3n";
		...
		this._tt_start_auto_rotate_white__text.innerHTML="Inicio Auto Rotaci\xf3n";
		...
		this._tt_info__text.innerHTML="Mostrar Informaci\xf3n";
		...
		this._tt_info_white__text.innerHTML="Mostrar Informaci\xf3n";
		...
		this._tt_movemode0__text.innerHTML="Cambiar Modo de Control";
		...
		this._tt_movemode_white0__text.innerHTML="Cambiar Modo de Control";
		...
		this._tt_movemode__text.innerHTML="Cambiar Modo de Control";
		...
		this._tt_movemode_white__text.innerHTML="Cambiar Modo de Control";
		...
		this._image_1.ggLeft=-120;
		this._image_1.ggTop=-85;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._ht_image2=document.createElement('div');
			this._ht_image2.ggId="ht_image2";
			this._ht_image2.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
			this._ht_image2.ggVisible=true;
			this._ht_image2.className='ggskin ggskin_container ';
			this._ht_image2.ggType='container';
			hs ='';
			hs+='height : 32px;';
			hs+='left : -15px;';
			hs+='position : absolute;';
			...
			hs+='width : 32px;';
			hs+='pointer-events:none;';
			this._ht_image2.setAttribute('style',hs);
			this._ht_image2.style[domTransform + 'Origin']='50% 50%';
			...
			me._ht_image2.ggElementNodeId=function() {
				if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
					return this.parentNode.ggElementNodeId();
				}
				return me.ggNodeId;
			}
			this._ht_image2.ggUpdatePosition=function (useTransition) {
			}
			...
			this._ht_image2.appendChild(this._rectangle_1);
			this._rectangle_12=document.createElement('div');
			this._rectangle_12.ggId="Rectangle 1-2";
			...
			me._rectangle_12.ggCurrentLogicStateScaling = -1;
			me._rectangle_12.ggCurrentLogicStateAlpha = -1;
			this._rectangle_12.ggUpdateConditionTimer=function () {
				var newLogicStateScaling;
				if (
					(ggSkinVars['ht_ani'] == true)
				)
			...
			this._ht_image2.appendChild(this._rectangle_12);
			this.__div.appendChild(this._ht_image2);
			this.hotspotTimerEvent=function() {
				...
				me._rectangle_12.ggUpdateConditionTimer();
			}
