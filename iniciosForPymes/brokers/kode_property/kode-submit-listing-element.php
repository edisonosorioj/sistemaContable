...
class kodeproperty_extend_vc_property_submit_listing_addon {
    function __construct() {
        // We safely integrate with VC with this hook
        add_action( 'init', array( $this, 'kodeproperty_vc_notice' ) );
 
        // Use this when creating a shortcode addon
        add_shortcode( 'submit_listing_item', array( $this, 'kodeproperty_print_element' ) );
        // Register CSS and JS
    ...
    */
    public function kodeproperty_print_element( $atts, $content = null ) {
		...
		$output = '<div class="row">'.kodeproperty_submit_listing($settings).'</div>';
		return $output;
    }
    /*
...
new kodeproperty_extend_vc_property_submit_listing_addon();