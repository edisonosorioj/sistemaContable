					...
					<div class="panel panel-widget forms-panel">
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								...
								<div class="form-body">
									<form action='actUsuario.php?id=<?php echo $iduser ?>' method="post"> 
										...
										<div class="form-group">
											...
											<input type="text" name="fecha_contrato" class="form-control" placeholder="Fecha Contrato" value="<?php echo $fecha_contrato; ?>"> 
										</div>
										<div class="form-group">
											<label>Fecha Fin Contrato</label> 
											<input type="text" name="fecha_fin_contrato" class="form-control" placeholder="Fecha fin de contrato" value="<?php echo $fecha_fin_contrato; ?>"> 
										</div> 
										<div class="form-group"> 
											<label>Nomina</label> 
